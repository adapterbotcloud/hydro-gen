...
export const Icons = {
  ...
  H2: ({ className }: IconProps = {}) => (
    <svg width="28" height="28" viewBox="0 0 32 32" fill="none" className={className}>
      ...
      <text x="16" y="21" textAnchor="middle" fill="#00E676" fontSize="13" fontFamily="Space Mono, monospace" fontWeight="700">H₂</text>
    </svg>
  ),
