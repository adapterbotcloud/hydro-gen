import { HiOutlineChatAlt2, HiOutlineChartBar, HiOutlineViewGrid, HiOutlineDocumentText, HiOutlinePaperAirplane, HiOutlineLightningBolt, HiOutlineLockClosed, HiOutlineGlobe, HiOutlineLink, HiOutlineMenu } from "react-icons/hi";
...
export const Icons = {
  ...
  Docs: () => <HiOutlineDocumentText className="w-5 h-5" />,
